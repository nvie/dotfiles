...
alias cdr='cd ~/Projects/liveblocks/liveblocks/packages/liveblocks-react && set-bg-color 17 23 60'
...
alias cdd='cd ~/Projects/liveblocks/liveblocks/packages/liveblocks-devtools && set-bg-color 73 39 10'
alias cdf='cd ~/Projects/liveblocks/liveblocks-cloudflare && set-bg-color 8 0 38'
alias cdb='cd ~/Projects/liveblocks/liveblocks-backend && set-bg-color 27 22 0'
